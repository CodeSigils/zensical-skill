...
| Feeds / RSS | [MkDocs plugin compatibility](https://zensical.org/docs/compatibility/mkdocs/plugins/) | Checked 2026-09-13 | RSS is listed as planned on the current compatibility roadmap. Do not claim native feed generation or add an integration without a concrete need, explicit authorization, a maintenance owner, and version-specific validation. |
